...
max_obstacles = 10 # Number of obstacles that will try to spawn (limit is about 20-25)
...
frontspeed = 40 #Speed in kmh of front vehicle (going to fast may break the PID)
