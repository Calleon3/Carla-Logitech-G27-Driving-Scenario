...
def back_control_update(world, frontvehicle, backvehicle):
    kp = 1.0
    kd = 0.5
    desired_distance = distance_from_front
...
################################################################################################################
        ...
        while True:
            ...
            back_control_update(world, frontvehicle, backvehicle)
