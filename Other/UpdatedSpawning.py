...
TIMEOUT = 10*1000  # Time in seconds * 1000 = milliseconds 
...
normal = False #set to true for car and false for van
...
def spawn_vehicles(world, spawn_points, frontvehicle_bp, backvehicle_bp, actor_list, tm, spectator):
    actors = []
...
################################################################################################################
        if normal:
            actors = spawn_vehicles(world, spawn_points, frontvehicle_bp, backvehicle_bp, actor_list, tm, spectator)
        else:
            actors = spawn_vehicles(world, spawn_points, altfrontvehicle_bp, backvehicle_bp, actor_list, tm, spectator)
